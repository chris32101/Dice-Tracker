    ...
    <v-container>
      ...
      <v-row>
        <v-col>
          ...
          <v-row v-for="index in teamLength" :key="index" justify="center">
            <v-col>
              <v-card>
                <v-card-title
                  ><v-text-field
                    @change="(input) => updateTeams(index - 1, input)"
                    label="Team Name"
                  ></v-text-field
                ></v-card-title>
                <v-card-text>
                  <v-select
                    ...
                    :items="computeItems"
                    @change="
                      (item) => addDisabled(item, index + 'a', index - 1)
                    "
                  ></v-select>
                  <v-select
                    label="Player 2"
                    :items="computeItems"
                    @change="
                      (item) => addDisabled(item, index + 'b', index - 1)
                    "
                  ></v-select>
                </v-card-text>
              </v-card>
